...
pub fn get_integrator(name: &str) -> Box<dyn Integrator> {
    match name {
        "int2e_breit_r1p2" => Box::new(int2e_breit_r1p2),
        "int2e_breit_r2p2" => Box::new(int2e_breit_r2p2),
        "int3c1e" => Box::new(int3c1e),
        "int3c1e_rinv" => Box::new(int3c1e_rinv),
        "int2e_stg" => Box::new(int2e_stg),
        "int2e_yp" => Box::new(int2e_yp),
        "int2e_yp_ip1" => Box::new(int2e_yp_ip1),
        "int2e_stg_ip1" => Box::new(int2e_stg_ip1),
        "int2e_yp_ipip1" => Box::new(int2e_yp_ipip1),
        "int2e_stg_ipip1" => Box::new(int2e_stg_ipip1),
        "int2e_yp_ipvip1" => Box::new(int2e_yp_ipvip1),
        "int2e_stg_ipvip1" => Box::new(int2e_stg_ipvip1),
        "int2e_yp_ip1ip2" => Box::new(int2e_yp_ip1ip2),
        "int2e_stg_ip1ip2" => Box::new(int2e_stg_ip1ip2),
        "int3c2e" => Box::new(int3c2e),
        "int2c2e" => Box::new(int2c2e),
        "int1e_ovlp" => Box::new(int1e_ovlp),
        "int1e_nuc" => Box::new(int1e_nuc),
        "int3c1e_r2_origk" => Box::new(int3c1e_r2_origk),
        "int3c1e_r4_origk" => Box::new(int3c1e_r4_origk),
        "int3c1e_r6_origk" => Box::new(int3c1e_r6_origk),
        "int3c1e_ip1_r2_origk" => Box::new(int3c1e_ip1_r2_origk),
        "int3c1e_ip1_r4_origk" => Box::new(int3c1e_ip1_r4_origk),
        "int3c1e_ip1_r6_origk" => Box::new(int3c1e_ip1_r6_origk),
        "int1e_grids" => Box::new(int1e_grids),
        "int4c1e" => Box::new(int4c1e),
        "int1e_r2_origi" => Box::new(int1e_r2_origi),
        "int1e_r4_origi" => Box::new(int1e_r4_origi),
        "int1e_r2_origi_ip2" => Box::new(int1e_r2_origi_ip2),
        "int1e_r4_origi_ip2" => Box::new(int1e_r4_origi_ip2),
        "int2e" => Box::new(int2e),
        "int1e_ipovlp" => Box::new(int1e_ipovlp),
        "int1e_ovlpip" => Box::new(int1e_ovlpip),
        "int1e_ipkin" => Box::new(int1e_ipkin),
        "int1e_kinip" => Box::new(int1e_kinip),
        "int1e_ipnuc" => Box::new(int1e_ipnuc),
        "int1e_iprinv" => Box::new(int1e_iprinv),
        "int1e_ipspnucsp" => Box::new(int1e_ipspnucsp),
        "int1e_ipsprinvsp" => Box::new(int1e_ipsprinvsp),
        "int1e_ippnucp" => Box::new(int1e_ippnucp),
        "int1e_ipprinvp" => Box::new(int1e_ipprinvp),
        "int1e_ipipipnuc" => Box::new(int1e_ipipipnuc),
        "int1e_ipipiprinv" => Box::new(int1e_ipipiprinv),
        "int1e_ipipnucip" => Box::new(int1e_ipipnucip),
        "int1e_ipiprinvip" => Box::new(int1e_ipiprinvip),
        "int1e_spspsp" => Box::new(int1e_spspsp),
        "int1e_spnuc" => Box::new(int1e_spnuc),
        "int2e_spv1" => Box::new(int2e_spv1),
        "int2e_vsp1" => Box::new(int2e_vsp1),
        "int2e_spsp2" => Box::new(int2e_spsp2),
        "int2e_spv1spv2" => Box::new(int2e_spv1spv2),
        "int2e_vsp1spv2" => Box::new(int2e_vsp1spv2),
        "int2e_spv1vsp2" => Box::new(int2e_spv1vsp2),
        "int2e_vsp1vsp2" => Box::new(int2e_vsp1vsp2),
        "int2e_spv1spsp2" => Box::new(int2e_spv1spsp2),
        "int2e_vsp1spsp2" => Box::new(int2e_vsp1spsp2),
        "int3c1e_p2" => Box::new(int3c1e_p2),
        "int3c1e_iprinv" => Box::new(int3c1e_iprinv),
        "int3c1e_ip1" => Box::new(int3c1e_ip1),
        "int1e_iprinvr" => Box::new(int1e_iprinvr),
        "int1e_iprinviprip" => Box::new(int1e_iprinviprip),
        "int1e_rinvipiprip" => Box::new(int1e_rinvipiprip),
        "int1e_ipiprinvrip" => Box::new(int1e_ipiprinvrip),
        "int1e_grids_ip" => Box::new(int1e_grids_ip),
        "int1e_grids_ipvip" => Box::new(int1e_grids_ipvip),
        "int1e_grids_spvsp" => Box::new(int1e_grids_spvsp),
        "int1e_grids_ipip" => Box::new(int1e_grids_ipip),
        "int2e_ig1" => Box::new(int2e_ig1),
        "int2e_gg1" => Box::new(int2e_gg1),
        "int2e_g1g2" => Box::new(int2e_g1g2),
        "int2e_p1vxp1" => Box::new(int2e_p1vxp1),
        "int2e_ip1v_rc1" => Box::new(int2e_ip1v_rc1),
        "int2e_ip1v_r1" => Box::new(int2e_ip1v_r1),
        "int2e_ipvg1_xp1" => Box::new(int2e_ipvg1_xp1),
        "int2e_ipvg2_xp1" => Box::new(int2e_ipvg2_xp1),
        "int1e_inuc_rcxp" => Box::new(int1e_inuc_rcxp),
        "int1e_inuc_rxp" => Box::new(int1e_inuc_rxp),
        "int2e_ip1" => Box::new(int2e_ip1),
        "int2e_ip2" => Box::new(int2e_ip2),
        "int2e_ipspsp1" => Box::new(int2e_ipspsp1),
        "int2e_ip1spsp2" => Box::new(int2e_ip1spsp2),
        "int2e_ipspsp1spsp2" => Box::new(int2e_ipspsp1spsp2),
        "int2e_ipsrsr1" => Box::new(int2e_ipsrsr1),
        "int2e_ip1srsr2" => Box::new(int2e_ip1srsr2),
        "int2e_ipsrsr1srsr2" => Box::new(int2e_ipsrsr1srsr2),
        "int2e_ssp1ssp2" => Box::new(int2e_ssp1ssp2),
        "int2e_ssp1sps2" => Box::new(int2e_ssp1sps2),
        "int2e_sps1ssp2" => Box::new(int2e_sps1ssp2),
        "int2e_sps1sps2" => Box::new(int2e_sps1sps2),
        "int2e_cg_ssa10ssp2" => Box::new(int2e_cg_ssa10ssp2),
        "int2e_giao_ssa10ssp2" => Box::new(int2e_giao_ssa10ssp2),
        "int2e_gssp1ssp2" => Box::new(int2e_gssp1ssp2),
        "int1e_sigma" => Box::new(int1e_sigma),
        "int1e_spsigmasp" => Box::new(int1e_spsigmasp),
        "int1e_srsr" => Box::new(int1e_srsr),
        "int1e_sr" => Box::new(int1e_sr),
        "int1e_srsp" => Box::new(int1e_srsp),
        "int1e_spsp" => Box::new(int1e_spsp),
        "int1e_sp" => Box::new(int1e_sp),
        "int1e_spnucsp" => Box::new(int1e_spnucsp),
        "int1e_sprinvsp" => Box::new(int1e_sprinvsp),
        "int1e_srnucsr" => Box::new(int1e_srnucsr),
        "int1e_sprsp" => Box::new(int1e_sprsp),
        "int1e_govlp" => Box::new(int1e_govlp),
        "int1e_gnuc" => Box::new(int1e_gnuc),
        "int1e_cg_sa10sa01" => Box::new(int1e_cg_sa10sa01),
        "int1e_cg_sa10sp" => Box::new(int1e_cg_sa10sp),
        "int1e_cg_sa10nucsp" => Box::new(int1e_cg_sa10nucsp),
        "int1e_giao_sa10sa01" => Box::new(int1e_giao_sa10sa01),
        "int1e_giao_sa10sp" => Box::new(int1e_giao_sa10sp),
        "int1e_giao_sa10nucsp" => Box::new(int1e_giao_sa10nucsp),
        "int1e_sa01sp" => Box::new(int1e_sa01sp),
        "int1e_spgsp" => Box::new(int1e_spgsp),
        "int1e_spgnucsp" => Box::new(int1e_spgnucsp),
        "int1e_spgsa01" => Box::new(int1e_spgsa01),
        "int1e_kin" => Box::new(int1e_kin),
        "int1e_ia01p" => Box::new(int1e_ia01p),
        "int1e_giao_irjxp" => Box::new(int1e_giao_irjxp),
        "int1e_cg_irxp" => Box::new(int1e_cg_irxp),
        "int1e_giao_a11part" => Box::new(int1e_giao_a11part),
        "int1e_cg_a11part" => Box::new(int1e_cg_a11part),
        "int1e_a01gp" => Box::new(int1e_a01gp),
        "int1e_igkin" => Box::new(int1e_igkin),
        "int1e_igovlp" => Box::new(int1e_igovlp),
        "int1e_ignuc" => Box::new(int1e_ignuc),
        "int1e_pnucp" => Box::new(int1e_pnucp),
        "int1e_z" => Box::new(int1e_z),
        "int1e_zz" => Box::new(int1e_zz),
        "int1e_r" => Box::new(int1e_r),
        "int1e_r2" => Box::new(int1e_r2),
        "int1e_r4" => Box::new(int1e_r4),
        "int1e_rr" => Box::new(int1e_rr),
        "int1e_rrr" => Box::new(int1e_rrr),
        "int1e_rrrr" => Box::new(int1e_rrrr),
        "int1e_z_origj" => Box::new(int1e_z_origj),
        "int1e_zz_origj" => Box::new(int1e_zz_origj),
        "int1e_r_origj" => Box::new(int1e_r_origj),
        "int1e_rr_origj" => Box::new(int1e_rr_origj),
        "int1e_r2_origj" => Box::new(int1e_r2_origj),
        "int1e_r4_origj" => Box::new(int1e_r4_origj),
        "int1e_p4" => Box::new(int1e_p4),
        "int1e_prinvp" => Box::new(int1e_prinvp),
        "int1e_prinvxp" => Box::new(int1e_prinvxp),
        "int1e_pnucxp" => Box::new(int1e_pnucxp),
        "int1e_irp" => Box::new(int1e_irp),
        "int1e_irrp" => Box::new(int1e_irrp),
        "int1e_irpr" => Box::new(int1e_irpr),
        "int1e_ggovlp" => Box::new(int1e_ggovlp),
        "int1e_ggkin" => Box::new(int1e_ggkin),
        "int1e_ggnuc" => Box::new(int1e_ggnuc),
        "int1e_grjxp" => Box::new(int1e_grjxp),
        "int1e_rinv" => Box::new(int1e_rinv),
        "int1e_drinv" => Box::new(int1e_drinv),
        "int1e_ipipovlp" => Box::new(int1e_ipipovlp),
        "int1e_ipovlpip" => Box::new(int1e_ipovlpip),
        "int1e_ipipkin" => Box::new(int1e_ipipkin),
        "int1e_ipkinip" => Box::new(int1e_ipkinip),
        "int1e_ipipnuc" => Box::new(int1e_ipipnuc),
        "int1e_ipnucip" => Box::new(int1e_ipnucip),
        "int1e_ipiprinv" => Box::new(int1e_ipiprinv),
        "int1e_iprinvip" => Box::new(int1e_iprinvip),
        "int1e_ipipr" => Box::new(int1e_ipipr),
        "int1e_iprip" => Box::new(int1e_iprip),
        "int2e_ipip1" => Box::new(int2e_ipip1),
        "int2e_ipvip1" => Box::new(int2e_ipvip1),
        "int2e_ip1ip2" => Box::new(int2e_ip1ip2),
        "int1e_ipippnucp" => Box::new(int1e_ipippnucp),
        "int1e_ippnucpip" => Box::new(int1e_ippnucpip),
        "int1e_ipipprinvp" => Box::new(int1e_ipipprinvp),
        "int1e_ipprinvpip" => Box::new(int1e_ipprinvpip),
        "int1e_ipipspnucsp" => Box::new(int1e_ipipspnucsp),
        "int1e_ipspnucspip" => Box::new(int1e_ipspnucspip),
        "int1e_ipipsprinvsp" => Box::new(int1e_ipipsprinvsp),
        "int1e_ipsprinvspip" => Box::new(int1e_ipsprinvspip),
        "int2e_ipip1ipip2" => Box::new(int2e_ipip1ipip2),
        "int2e_ipvip1ipvip2" => Box::new(int2e_ipvip1ipvip2),
        "int1e_ipiprinvipip" => Box::new(int1e_ipiprinvipip),
        "int1e_ipipiprinvip" => Box::new(int1e_ipipiprinvip),
        "int1e_ipipipiprinv" => Box::new(int1e_ipipipiprinv),
        "int2e_spsp1" => Box::new(int2e_spsp1),
        "int2e_spsp1spsp2" => Box::new(int2e_spsp1spsp2),
        "int2e_srsr1" => Box::new(int2e_srsr1),
        "int2e_srsr1srsr2" => Box::new(int2e_srsr1srsr2),
        "int2e_cg_sa10sp1" => Box::new(int2e_cg_sa10sp1),
        "int2e_cg_sa10sp1spsp2" => Box::new(int2e_cg_sa10sp1spsp2),
        "int2e_giao_sa10sp1" => Box::new(int2e_giao_sa10sp1),
        "int2e_giao_sa10sp1spsp2" => Box::new(int2e_giao_sa10sp1spsp2),
        "int2e_g1" => Box::new(int2e_g1),
        "int2e_spgsp1" => Box::new(int2e_spgsp1),
        "int2e_g1spsp2" => Box::new(int2e_g1spsp2),
        "int2e_spgsp1spsp2" => Box::new(int2e_spgsp1spsp2),
        "int2e_pp1" => Box::new(int2e_pp1),
        "int2e_pp2" => Box::new(int2e_pp2),
        "int2e_pp1pp2" => Box::new(int2e_pp1pp2),
        "int2e_gauge_r1_ssp1ssp2" => Box::new(int2e_gauge_r1_ssp1ssp2),
        "int2e_gauge_r1_ssp1sps2" => Box::new(int2e_gauge_r1_ssp1sps2),
        "int2e_gauge_r1_sps1ssp2" => Box::new(int2e_gauge_r1_sps1ssp2),
        "int2e_gauge_r1_sps1sps2" => Box::new(int2e_gauge_r1_sps1sps2),
        "int2e_gauge_r2_ssp1ssp2" => Box::new(int2e_gauge_r2_ssp1ssp2),
        "int2e_gauge_r2_ssp1sps2" => Box::new(int2e_gauge_r2_ssp1sps2),
        "int2e_gauge_r2_sps1ssp2" => Box::new(int2e_gauge_r2_sps1ssp2),
        "int2e_gauge_r2_sps1sps2" => Box::new(int2e_gauge_r2_sps1sps2),
        "int3c2e_ip1" => Box::new(int3c2e_ip1),
        "int3c2e_ip2" => Box::new(int3c2e_ip2),
        "int3c2e_pvp1" => Box::new(int3c2e_pvp1),
        "int3c2e_pvxp1" => Box::new(int3c2e_pvxp1),
        "int2c2e_ip1" => Box::new(int2c2e_ip1),
        "int2c2e_ip2" => Box::new(int2c2e_ip2),
        "int3c2e_ig1" => Box::new(int3c2e_ig1),
        "int3c2e_spsp1" => Box::new(int3c2e_spsp1),
        "int3c2e_ipspsp1" => Box::new(int3c2e_ipspsp1),
        "int3c2e_spsp1ip2" => Box::new(int3c2e_spsp1ip2),
        "int3c2e_ipip1" => Box::new(int3c2e_ipip1),
        "int3c2e_ipip2" => Box::new(int3c2e_ipip2),
        "int3c2e_ipvip1" => Box::new(int3c2e_ipvip1),
        "int3c2e_ip1ip2" => Box::new(int3c2e_ip1ip2),
        "int2c2e_ipip1" => Box::new(int2c2e_ipip1),
        "int2c2e_ip1ip2" => Box::new(int2c2e_ip1ip2),
