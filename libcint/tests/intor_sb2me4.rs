...
mod test {
    ...
    #[rstest]
    #[case("int2c2e"        , "s1"  , None                , -935.2694687735325    , [366, 366]    )] // no-deriv
    #[case("int1e_igovlp"   , "s1"  , None                , -106.16961857524265   , [366, 366, 3] )] // deriv
    ...
    #[case("int2c2e"        , "s2ij", None                , 1809.6733664015762    , [67161]       )] // no-deriv | s2ij
    #[case("int1e_igovlp"   , "s2ij", None                , -40.08094621810594    , [67161, 3]    )] // deriv | s2ij
    ...
    #[rstest]
    #[case("ECPscalar"         , "s1"  , None                , 0.7534281412150909    , [366, 366]    )] // no-deriv
    #[case("ECPscalar_ignuc"   , "s1"  , None                , -1.3426139111770714   , [366, 366, 3] )] // deriv
    ...
    #[case("ECPscalar"         , "s2ij", None                , -1.8388155709304113   , [67161]       )] // no-deriv | s2ij
    #[case("ECPscalar_iprinvip", "s2ij", None                , -68.89774165957373    , [67161, 9]    )] // deriv | s2ij
    ...
    #[rstest]
    #[case("ECPscalar"         , "s1"  , None                , 1.6418489688115985    , [410, 410]    )] // no-deriv
    #[case("ECPscalar_ignuc"   , "s1"  , None                , -16.389862409392386   , [410, 410, 3] )] // deriv
    ...
    #[case("ECPscalar"         , "s2ij", None                , -9.966466894809031    , [84255]       )] // no-deriv | s2ij
    #[case("ECPscalar_iprinvip", "s2ij", None                , 132.938348145421      , [84255, 9]    )] // deriv | s2ij
