// Reference source: libcint/scripts/pyscf_h2o_tzvp.ipynb
...
mod test {
    ...
    #[case("int2e_ip1"          , "s2kl", [[0, 12], [8, 18], [6, 15], [6, 15]]  , 30.740874132068775    , [32, 26, 435, 3]      )] // deriv | shl
    // s4
    #[case("int2e"              , "s4"  , None                                  , -2.193730880853455    , [946, 946]            )] // no-deriv
    #[case("int2e"              , "s4"  , [[0, 12], [0, 12], [6, 15], [6, 15]]  , 3.2842989444370265    , [528, 435]            )] // no-deriv | shl
    // s8
