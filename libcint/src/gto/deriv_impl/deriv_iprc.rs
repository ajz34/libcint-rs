...
pub fn gto_shell_eval_grid_cart_iprc(
    ...
    let dr = [center[X] - common_origin[X], center[Y] - common_origin[Y], center[Z] - common_origin[Z]];
    ...
    for g in 0..BLKSIMDD {
        ...
        for p in 0..nprim {
            ...
            gto_x1_simdd(&mut f1, &f0, l, dr);
            gto_nabla1_simdd(&mut f2, &f0, l + 1, alpha[p]);
            gto_x1_simdd(&mut f3, &f2, l, dr);
...
impl GtoEvalAPI for GtoEvalDerivIpRc {
    ...
    fn gto_shell_eval(
        ...
        gto_shell_eval_grid_cart_iprc(gto, ebuf, coord, alpha, coeff, l, center, self.common_origin, shl_shape);
    }
}
