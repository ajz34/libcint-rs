...
pub fn gto_contract_exp1<const NLANE: usize>(
    // arguments
    ...
    for p in 0..nprim {
        ...
        for k in 0..nctr {
            ...
            for g in 0..NLANE {
                ...
                *ectr_2a[k].get_simdd_mut(g) = eprim.get_simdd(g) * coeff_2a + ectr_2a[k].get_simdd(g);
            }
        }
    }
}
...
impl<const NLANE: usize> GtoEvalAPI<NLANE> for GtoEvalDeriv1 {
    fn ne1(&self) -> usize {
        1
    }
