...
use crate::{impl_integrator, impl_integrator_sph_only};
use core::any::Any;
...
def gen_impl_integrator_sph_only(intor):
    token = """impl_integrator_sph_only!(
    {0:},
    {0:}_optimizer,
    {0:}_sph,
    {2:}, {3:}, {4:}, vec!{5:},
...
for intor in actual_intor:
    if "_stg" in intor or "_yp" in intor:
        token_wrapper += gen_impl_integrator_sph_only(intor)
